[PSCustomObject]@{
    ...
    Welcome         = "
╔═══════════════════════════════════════════════════╗
║      Selamat datang wahai Bajak Laut              ║
╚═══════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify terdeteksi, harus diinstal setelah SayMaven, buka tindakan yang direkomendasikan di FAQ? [Y/N]"
    NoRestore       = "SayMaven sudah diinstal, xpui.bak tidak ditemukan. `nSilakan uninstall aplikasi Spotify dan jalankan Install.bat lagi"
