[PSCustomObject]@{
    Welcome         = "
╔═══════════════════════════════════════════════════╗
║ Selamat datang wahai Abamtukam di Spotify Bajakan ║
╚═══════════════════════════════════════════════════╝"
    ...
    Download4       = "Periksa pengaturan jaringan Anda bung dan jalankan instalasi lagi"
    Download5       = "Sabar abang ku lagi mengunduh Spotify"
    ...
    OldV2           = "Versi Spotify {0} Anda sudah zaman megalitikum, disarankan untuk upgrade ke versi {1}"
    ...
    DownSpoti       = "Download dan memasang Spotify bajakan sabar abang ku"
    DownSpoti2      = "Tunggu sebentar..."
    PodcatsOff      = "Podcast Nonaktif"
    PodcastsOn      = "Podcast Aktif"
    PodcatsSelect   = "Matiin gk nih podcast, episode, dan audiobooks dari halaman utama? [Y/N]"
    DowngradeNote   = "Disarankan untuk memblokir karena Spotify telah di downgrade"
    UpdBlock        = "Pembaruan Mantan anda dibanned"
    UpdUnblock      = "Pembaruan Spotify tidak diblokir"
    UpdSelect       = "Blokir gak nih pembaruan Spotify? [Y/N]"
    ...
    NoRestore       = "Versi bajakan sudah diinstal, xpui.bak tidak ditemukan. `nSilakan uninstall aplikasi Spotify dan jalankan Install.bat lagi"
    InstallComplete = "membajak telah selesai"
    ...
    PressAnyKey     = "Putusin pacar dan tobat untuk keluar..."
}
